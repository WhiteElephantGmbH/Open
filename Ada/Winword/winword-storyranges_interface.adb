...
package body winword.StoryRanges_Interface is

   procedure Initialize (This : in out StoryRanges_Type) is
   begin
      Set_IID (This, IID_StoryRanges);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_StoryRanges (Address (This));
   end Pointer;
