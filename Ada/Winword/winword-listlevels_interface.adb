...
package body winword.ListLevels_Interface is

   procedure Initialize (This : in out ListLevels_Type) is
   begin
      Set_IID (This, IID_ListLevels);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_ListLevels (Address (This));
   end Pointer;
   ...
   is
       RetVal : aliased Pointer_To_ListLevel;
   begin
      GNATCOM.Errors.Error_Check
