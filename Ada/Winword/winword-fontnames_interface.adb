...
package body winword.FontNames_Interface is

   procedure Initialize (This : in out FontNames_Type) is
   begin
      Set_IID (This, IID_FontNames);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_FontNames (Address (This));
   end Pointer;
