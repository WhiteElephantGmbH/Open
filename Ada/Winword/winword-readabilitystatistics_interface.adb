...
package body winword.ReadabilityStatistics_Interface is

   procedure Initialize (This : in out ReadabilityStatistics_Type) is
   begin
      Set_IID (This, IID_ReadabilityStatistics);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_ReadabilityStatistics (Address (This));
   end Pointer;
   ...
   is
       RetVal : aliased Pointer_To_ReadabilityStatistic;
   begin
      GNATCOM.Errors.Error_Check
