...
package body winword.OtherCorrectionsException_Interface is

   procedure Initialize (This : in out OtherCorrectionsException_Type) is
   begin
      Set_IID (This, IID_OtherCorrectionsException);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_OtherCorrectionsException (Address (This));
   end Pointer;
