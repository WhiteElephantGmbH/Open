...
package body winword.Sentences_Interface is

   procedure Initialize (This : in out Sentences_Type) is
   begin
      Set_IID (This, IID_Sentences);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_Sentences (Address (This));
   end Pointer;
