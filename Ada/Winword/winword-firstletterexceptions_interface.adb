...
package body winword.FirstLetterExceptions_Interface is

   procedure Initialize (This : in out FirstLetterExceptions_Type) is
   begin
      Set_IID (This, IID_FirstLetterExceptions);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_FirstLetterExceptions (Address (This));
   end Pointer;
   ...
   is
       RetVal : aliased Pointer_To_FirstLetterException;
   begin
      GNATCOM.Errors.Error_Check
