...
package body winword.MappedDataFields_Interface is

   procedure Initialize (This : in out MappedDataFields_Type) is
   begin
      Set_IID (This, IID_MappedDataFields);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_MappedDataFields (Address (This));
   end Pointer;
   ...
   is
       RetVal : aliased Pointer_To_MappedDataField;
   begin
      GNATCOM.Errors.Error_Check
