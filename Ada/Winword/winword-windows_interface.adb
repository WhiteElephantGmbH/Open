...
package body winword.Windows_Interface is

   procedure Initialize (This : in out Windows_Type) is
   begin
      Set_IID (This, IID_Windows);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_Windows (Address (This));
   end Pointer;
