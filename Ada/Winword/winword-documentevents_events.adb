package body winword.DocumentEvents_Events is
   ...
   begin
      case dispidMember is
         when DocumentEvents_uNew=>
            uNew
              (DocumentEvents_Event'Class (Event_Object.all));
         when DocumentEvents_Open=>
            Open
              (DocumentEvents_Event'Class (Event_Object.all));
         when DocumentEvents_Close=>
            Close
              (DocumentEvents_Event'Class (Event_Object.all));
         when others =>
            null;
