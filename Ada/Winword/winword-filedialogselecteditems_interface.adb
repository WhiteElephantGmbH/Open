...
package body winword.FileDialogSelectedItems_Interface is

   procedure Initialize (This : in out FileDialogSelectedItems_Type) is
   begin
      Set_IID (This, IID_FileDialogSelectedItems);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_FileDialogSelectedItems (Address (This));
   end Pointer;
