...
package body winword.FootnoteOptions_Interface is

   procedure Initialize (This : in out FootnoteOptions_Type) is
   begin
      Set_IID (This, IID_FootnoteOptions);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_FootnoteOptions (Address (This));
   end Pointer;
