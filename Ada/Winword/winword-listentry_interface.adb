...
package body winword.ListEntry_Interface is

   procedure Initialize (This : in out ListEntry_Type) is
   begin
      Set_IID (This, IID_ListEntry);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_ListEntry (Address (This));
   end Pointer;
