...
package body winword.HeadersFooters_Interface is

   procedure Initialize (This : in out HeadersFooters_Type) is
   begin
      Set_IID (This, IID_HeadersFooters);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_HeadersFooters (Address (This));
   end Pointer;
