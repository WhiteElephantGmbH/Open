...
package body winword.DiagramNodeChildren_Interface is

   procedure Initialize (This : in out DiagramNodeChildren_Type) is
   begin
      Set_IID (This, IID_DiagramNodeChildren);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_DiagramNodeChildren (Address (This));
   end Pointer;
   ...
   begin
      GNATCOM.Errors.Error_Check
        (Pointer (This).Vtbl.Get_FirstChild
         (Pointer (This),
          RetVal'Unchecked_Access));
   ...
   begin
      GNATCOM.Errors.Error_Check
        (Pointer (This).Vtbl.Get_LastChild
         (Pointer (This),
          RetVal'Unchecked_Access));
