...
package body winword.Templates_Interface is

   procedure Initialize (This : in out Templates_Type) is
   begin
      Set_IID (This, IID_Templates);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_Templates (Address (This));
   end Pointer;
