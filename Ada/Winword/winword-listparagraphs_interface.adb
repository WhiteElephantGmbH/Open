...
package body winword.ListParagraphs_Interface is

   procedure Initialize (This : in out ListParagraphs_Type) is
   begin
      Set_IID (This, IID_ListParagraphs);
   end Initialize;
   ...
   is
   begin
      return To_Pointer_To_ListParagraphs (Address (This));
   end Pointer;
