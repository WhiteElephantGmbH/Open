...
--   WS_CAPTION          : constant := 12582912;
   ...
   begin
      if Window.On_Change_Cursor_Event = null then
         GWindows.Cursors.Set_Cursor (Default_Cursor);
      else
   ...
   is
      ...
      Fill_Window    : Pointer_To_Base_Window_Class :=
        Pointer_To_Base_Window_Class (MDI_Client_Window (Window));
      ...
      begin
         if
           Parent (Child.all).all'Address = Window'Address
         then
