...
--     MB_ICONSTOP                : constant := 16;
   ...
   is
      ...
      function MessageBox
        (hwnd    : in Interfaces.C.long       := GWindows.Base.Handle (Window);
         Message : in GString_C;
         Title   : in GString_C;
   ...
   begin
      ...
      Result := MessageBox (Message => BoxMessage,
                            Title   => BoxTitle,
   ...
   begin
      Result := Message_Box (Window, Title, Text, Style, Icon);
   end Message_Box;
   ...
   begin
      return Message_Box (Tmp_Win, Title, Text, Style, Icon);
   end Message_Box;
   ...
   is
      Result : Message_Box_Result;
   begin
      Result := Message_Box (Title, Text, Style, Icon);
   end Message_Box;
