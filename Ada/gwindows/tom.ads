...
--  Generated on             : 22.04.03 14:23:48
--  Library Name             : tom
...
package TOM is
   ...
   type Pointer_To_Pointer_To_ITextSelection is access all Pointer_To_ITextSelection;
   type Pointer_To_ITextStoryRanges is access all ITextStoryRanges;
   type Pointer_To_Pointer_To_ITextStoryRanges is access all Pointer_To_ITextStoryRanges;
