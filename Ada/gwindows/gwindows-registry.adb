...
package body GWindows.Registry is
   ...
   function Current_Directory return GString is
      ...
      function GetModuleFileName
        (hInst        : Interfaces.C.long       :=
         ...
         lpszFileName : Interfaces.C.char_array := Server_Path;
         cbFileName   : Integer                 := MAX_PATH)
        return Integer;
   ...
   begin
      ...
      declare
         Tmp   : String := Interfaces.C.To_Ada (Server_Path);
   ...
   is
      ...
      procedure GetShortPathName
        (lpszLongPath  : GString_C := Server_Path;
         lpszShortPath : GString_C := Server_Path;
   ...
   is
      ...
      function RegSetValueEx
        (hKey        : Interfaces.C.long          := Key;
         lpValueName : GString_C                  := Name_Name;
         reserved    : Interfaces.C.unsigned_long := 0;
         dwType      : Integer                    := REG_SZ;
         lpData      : GString_C                  := Value_Data;
   ...
   begin
      ...
      declare
         Name_Buf  : GString_C
           (0 .. Interfaces.C.size_t (Max_Name)) :=
   ...
   begin
      ...
      declare
         C_Result : GString_C
           (0 .. Interfaces.C.size_t (Max_Value)) :=
           (others => GString_C_Null);

         procedure RegQueryValueEx
           (HKEY  : in     Interfaces.C.long := Key;
            Name  : in     GString_C         := C_Name;
            A     : in     Integer           := 0;
            B     : in     Integer           := 0;
            Value : in     GString_C         := C_Result;
