...
package GWindows.Base is
   ...
   --  Cleans resources for dynamically created windows. Will also close window
   --  if it is open.
   ...
   procedure Enumerate_Children (Window : Base_Window_Type;
                                 Proc   : Enumerate_Function);
   ...
   procedure Get_Canvas (Window : in     Base_Window_Type;
   ...
   --  On message from custom controls
   --  If control /= null then the message will be routed down to control
