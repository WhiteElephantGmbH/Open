...
--   SCI_GRABFOCUS                  : constant := 16#0960#;
   ...
   is
      ...
      TR     : Text_Range_Type := (Min, Max, Buffer (Buffer'First)'Address);
      Length : Integer;
   begin
   ...
   is
      ...
      NM : PSTRUCT_SCNOTIFICATION := To_PSTRUCT_SCNOTIFICATION (Message);
         ...
         when SCN_MODIFIED =>
            ...
            begin
               if NM.text /= System.Null_Address then
                  declare
                     S : Pointer_To_Text_Array := To_PTA (NM.text);
                     T : GWindows.GString :=
