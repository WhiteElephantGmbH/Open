...
package body GWindows.GStrings.IO is
   ...
   begin
      ...
      declare
         Convert_String   : String (1 .. 2) := Value & " ";
         Converted_String : GString := To_GString_From_String (Convert_String);
      begin
   ...
   procedure Put (C : GCharacter) is
      Convert_String   : GString := C & " ";
      Converted_String : String (1 .. 2) := To_String (Convert_String);
   begin
