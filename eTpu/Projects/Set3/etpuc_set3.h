...
*
*******************************************************************************/ 
#ifndef __ETPUC_SET3_H
#define __ETPUC_SET3_H


/*******************************************************************************
    MEMORY SIZE DEFINITION
*******************************************************************************/
#define MEMORY_SIZE            6*1024   // 6 kbytes
#define LAST_FUNCTION              11   // Number of the last assigned function

/*******************************************************************************
    GLOBAL ERROR FUNCTION NUMBERS ASSIGNMENT
...
//#define QD_HOME_FUNCTION_NUMBER     4
//#define QD_INDEX_FUNCTION_NUMBER    5
